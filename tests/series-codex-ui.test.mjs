...
const service = await moduleAt('features/codex/series-codex-service')
const { metadataValues } = await moduleAt('features/chat/chat-management-schema')
const { CodexScopeControls } = await moduleAt('features/codex/SeriesCodexControls')
