...
const { markdownTableRanges } = await import('../src/features/editor/markdown-tables.ts')
const { markdownTablePreview } = await import('../src/features/editor/MarkdownTablePreview.tsx')
const { default: MarkdownEditor } = await import('../src/features/editor/MarkdownEditor.tsx')
const { default: MarkdownTable } = await import('../src/features/editor/MarkdownTable.tsx')
