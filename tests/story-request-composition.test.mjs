...
test('Story migration, shared preview, and provider dispatch use the composition request', () => {
  ...
  assert.match(workspaceSource, /normalizedRequest: requestSnapshot\.normalizedRequest/)
  assert.match(appSource, /normalizedRequest = assembleStoryGenerationRequest/)
