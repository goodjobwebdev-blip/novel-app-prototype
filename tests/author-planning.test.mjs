...
const p = await import('../src/data/persistence.ts'), planning = await import('../src/features/author-planning/author-planning.ts'), service = await import('../src/features/author-planning/author-planning-service.ts')
const chat = await import('../src/features/chat/chat-service.ts'), management = await import('../src/features/chat/chat-management-tools.ts'), actions = await import('../src/features/chat/chat-entity-tools.ts')
const { initialAiSettings } = await import('../src/shared/ai/ai-settings.ts')
const archive = await import('../src/data/book-archive.ts'), { encodeDocumentBlock } = await import('../src/features/editor/document-projection.ts')
const { proposalDraftValues } = await import('../src/features/chat/chat-proposal-draft.ts')
