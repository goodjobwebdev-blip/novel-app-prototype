...
const t = await import('../src/features/codex/lore-types-service.ts')
...
const { executeChatWorkspaceTool, createChatCodexEntry } = await import('../src/features/chat/chat-tools.ts')
const { executeChatEntityTool } = await import('../src/features/chat/chat-entity-tools.ts')
