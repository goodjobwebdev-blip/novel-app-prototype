...
const s = await import('../src/features/chat/chat-skills.ts')
const c = await import('../src/features/chat/chat-service.ts')
const { assembleChatGenerationRequest, defaultChatPromptComposition, finalizeChatProviderRequest } = await import('../src/features/chat/chat-request.ts')
