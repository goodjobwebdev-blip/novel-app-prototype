...
const p = await import('../src/data/persistence.ts'), c = await import('../src/features/chat/character-chat.ts'), chat = await import('../src/features/chat/chat-service.ts')
...
const { finalizeChatProviderRequest } = await import('../src/features/chat/chat-request.ts')
