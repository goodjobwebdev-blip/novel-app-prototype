...
const typesService = await moduleAt('features/codex/lore-types-service')
const { LoreTypesManager, LoreTypeSelect } = await moduleAt('features/codex/LoreTypesControls')
