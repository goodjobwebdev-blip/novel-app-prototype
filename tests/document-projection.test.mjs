...
const { prepareAutotitleRequest } = await import('../src/features/writing/autotitle-service.ts')
const { normalizeSpeakableText } = await import('../src/features/speech/tts-service.ts')
const { executeChatWorkspaceTool } = await import('../src/features/chat/chat-tools.ts')
const { assembleStoryGenerationRequest, defaultStoryPromptComposition } = await import('../src/features/writing/story-request.ts')
