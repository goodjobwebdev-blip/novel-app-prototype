...
import { bookTemplateValues, renderPromptTemplate, type BookPromptValues } from '../../shared/ai/prompt-template'
import type { DynamicContextSource } from '../../shared/ai/prompt-composition'
