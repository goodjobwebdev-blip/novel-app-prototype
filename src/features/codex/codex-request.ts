import { projectProse } from '../editor/document-projection.ts'
import { bookTemplateValues, type BookPromptValues } from '../../shared/ai/prompt-template.ts'
import {
...
} from '../../shared/ai/prompt-composition.ts'
