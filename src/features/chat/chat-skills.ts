...
import { database, listEntitiesByBook, updateEntityAtomically, type GenerationContextProfile, type NoteEntity } from '../../data/persistence'
import { projectProse } from '../editor/document-projection'
import { buildContextValues } from '../../shared/context/context-service'
