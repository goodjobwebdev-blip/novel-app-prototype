import { authorPlanChanges, type AuthorGoal, type AuthorTask } from '../author-planning/author-planning'
import { BUILTIN_LORE_TYPES, type LoreType } from '../codex/lore-types.ts'
