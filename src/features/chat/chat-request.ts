...
import { loreTypesForTools, type LoreType } from '../codex/lore-types'
...
import { bookTemplateValues, type BookPromptValues } from '../../shared/ai/prompt-template'
import {
...
} from '../../shared/ai/prompt-composition'
