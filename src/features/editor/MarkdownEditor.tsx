...
import { findTriggerRanges, type CodexMentionTerm } from '../codex/codex-trigger-service'
import { normalizeTranscriptForInsertion } from '../speech/stt-service'
import {
  Decoration,
  EditorView,
  ViewPlugin,
...
import '../codex/codex-mentions.css'
