...
export const promptVariables: PromptVariable[] = [
  ...
  { name: RESPONSE_LENGTH_VARIABLE, description: 'Response-length guidance for this generation type', scopes: ['story', 'summarize', 'lore'], stability: 'book-state', canonical: true },
  ...
  { name: 'scene.effective_pov', description: 'Resolved pov: scene override, otherwise live book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.pov_origin', description: 'Origin of effective pov: Scene override or Book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.tense', description: 'Explicit scene tense override; empty inherits from book', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.effective_tense', description: 'Resolved tense: scene override, otherwise live book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.tense_origin', description: 'Origin of effective tense: Scene override or Book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.style', description: 'Explicit scene style override; empty inherits from book', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.effective_style', description: 'Resolved style: scene override, otherwise live book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.style_origin', description: 'Origin of effective style: Scene override or Book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.language', description: 'Explicit scene language override; empty inherits from book', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.effective_language', description: 'Resolved language: scene override, otherwise live book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.language_origin', description: 'Origin of effective language: Scene override or Book default', scopes: ['story'], stability: 'turn-dynamic', canonical: true },
  { name: 'scene.previous_text', description: 'Previous Scene when automatic rules expose it', scopes: ['story', 'lore', 'assistant'], stability: 'turn-dynamic', canonical: true },
  { name: 'story.so_far', description: 'Hierarchically compressed earlier-story state', scopes: ['story', 'lore', 'assistant'], stability: 'turn-dynamic', canonical: true },
  { name: 'context.automatic', description: 'Complete automatically assembled context for this scope', scopes: ['story', 'lore', 'assistant'], stability: 'turn-dynamic', canonical: true },
  ...
  { name: 'target.title', description: 'Title or name of the current Summary source', scopes: ['summarize'], stability: 'turn-dynamic', canonical: true },
  ...
  { name: 'entry.after_cursor', description: 'Codex entry text after the captured generation point', scopes: ['lore'], stability: 'turn-dynamic', canonical: true },
